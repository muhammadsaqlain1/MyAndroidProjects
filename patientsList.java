...
/**
 * Created by usman on 5/10/2018.
 */

public class patientsList extends BaseAdapter implements ListAdapter {
    private final Activity activity;
    private final JSONArray jsonArray;
    public patientsList(Activity activity, JSONArray jsonArray) {
